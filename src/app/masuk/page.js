      ...
      <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-gray-100 min-h-full flex flex-col items-center justify-center">
        ...
        <div className="w-full max-w-2xl flex flex-col items-center">
          ...
          <div className="bg-gray-100/80 px-6 py-2.5 rounded-xl mb-12">
            <h3 className="text-gray-700 font-bold text-[15px]">Form Transaksi Masuk</h3>
          </div>
          ...
          <form className="w-full flex flex-col gap-8">
            ...
            <div className="relative">
              ...
              {/* Custom dropdown arrow if needed, but appearance-none removes it. 
                  Let's just keep default appearance or add a custom chevron.
                  Actually, select without appearance-none has standard arrow. Let's keep appearance-auto or remove appearance-none. */}
            </div>
